...
class _FaqPageState extends State<FaqPage> {
  ...
  void initState() {
    ...
    DatabaseReference faqRef =
        FirebaseDatabase.instance.reference().child("FAQ");

    faqRef.once().then((DataSnapshot snapshot) {
      panels = [];
      var values = snapshot.value;
      var keys = snapshot.value.keys;
      for (var key in keys) {
        Panel panel =
            Panel(values[key]["title"], values[key]["content"], false);
