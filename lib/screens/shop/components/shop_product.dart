        ...
        child: Column(
          children: <Widget>[
           Padding(
            ...
            Text(
              'ETB ${product.Real_Product_price}',
              textAlign: TextAlign.center,
              style: TextStyle(
...
class ShopProductDisplay extends StatelessWidget {
  ...
  const ShopProductDisplay(this.cart,{Key key,this.onPressed}) : super(key: key);
      ...
      child: Stack(children: <Widget>[
        ...
        Positioned(
          ...
          child: SizedBox(
              height:80,
              width: 80,
              child: Image.network('${cart.Product_Image}',fit: BoxFit.contain,)),
        ),
        Positioned(
          right: 30,
          bottom: 25,
